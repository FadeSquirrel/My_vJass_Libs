library MovementLib
	...
	function GetUnitZ takes unit whichUnit returns real
		return GetUnitFlyHeight(whichUnit) + GetLocZ(GetUnitX(whichUnit), GetUnitY(whichUnit))
		
	endfunction
	
	function SetUnitZ takes unit whichUnit, real z returns nothing 
		call SetUnitFlyHeight(whichUnit, z - GetLocZ(GetUnitX(whichUnit), GetUnitY(whichUnit)), 0)
